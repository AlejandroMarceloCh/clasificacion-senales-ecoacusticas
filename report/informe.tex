...
lo que muestra que la partición más clara es la dicotomía
...
Esto muestra que separar especies parecidas necesita información supervisada.
...
\textbf{Relación costo-rendimiento.} El MLP supera al ensamble en
calidad ($+\deltaMLP$ F1-macro) con una latencia $\factorLat\times$ menor ($\latMlp$ vs.\ $\latXgb$ ms/muestra),
suficientemente rápida para uso en tiempo real. Se eligió entonces como modelo de despliegue.
